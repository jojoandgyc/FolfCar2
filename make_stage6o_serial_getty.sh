...
DST="$IMGDIR/opi5p-rj45-stage6o-fe180000-phy2-rj45fix-uart039-login1500000.img"
OFFSET=$((61440 * 512))
...
[Service]
ExecStart=
ExecStart=-/sbin/agetty -L --noissue --keep-baud 1500000,115200,57600,38400,9600 %I $TERM
EOF
